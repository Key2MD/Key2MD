...
function _showRandWarning() {
 ...
 d.textContent = 'Timer 1 minute remaining - start wrapping up.';
 area.appendChild(d);
}
...
function _showRandReshowBtn(allPrompts) {
 ...
 banner.textContent = 'Warning Stop speaking while prompts are visible. Click "Hide & resume" to continue.';
