  ...
  trigger.addEventListener('click', async () => {
   ...
   try {
    ...
    if (liftedPrompts) {
     ...
     liftBody = `<div class="mmi-lift-section-label">Key fixes for this answer</div><div class="mmi-lift-answer">${esc(mildRec)}</div><div class="mmi-lift-upsell" style="margin-top:12px;padding:11px 14px;border:1px solid rgba(14,165,233,0.28);border-radius:10px;background:rgba(14,165,233,0.06);font-size:0.82rem;line-height:1.5;color:#0a1628;">Those are your key fixes. <strong>Premium</strong> rewrites your full answer, prompt by prompt, in your own voice. <a href="plans.html#mmi-section" style="color:#0ea5e9;font-weight:700;text-decoration:none;">See Premium -></a></div>`;
    } else {
